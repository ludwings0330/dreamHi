...
const ActorDetail = () => {
  ...
  const [actorInfo, setActorInfo] = useState({
    ...
    phone: '01012341234',
    picrtureUrl:
      'https://firebasestorage.googleapis.com/v0/b/dreamhi-17f24.appspot.com/o/logo.png?alt=media&token=a3ff4d49-9210-44d1-94e3-6d9d2dd64f22',
  ...
  return (
    <>
      <div className="photo" width={'400px'} height={'500px'}>
        <img src={actorInfo.picrtureUrl} alt="image" className="object-center" />
      </div>
      ...
      {actorInfo.styles.length > 0 &&
        actorInfo.styles.map((actor, idx) => <div>{actor['description']}</div>)}
